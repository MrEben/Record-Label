          ...
          <article className="apply-content">
            <div className="apply-upper">
              <div className="apply-text">
                <h5>APPLY NOW</h5>
                <h1>
                  Work for <i>yourself</i>, not by yourself with{" "}
                  <span>busy</span> Entertainment
                </h1>
                <h4>
                  Send us a message and we'll get it answered as soon as
                  possible
                </h4>
            ...
            <div className="apply-form">
              <form className="form-itself">
                ...
                <p>
                  ...
                  veritatis aliquam odit itaque animi! nsbdvjah apples ans
                  fruiyt plO rw
                </p>
              </form>
            </div>
            <div className="apply-lower">
              <div className="apply-lower-text">
                ...
                <p>
                  Reach us at <span>info@busyentertainment.yahoo.org</span> and
